...
router.get("/all/:limit/:pageNumber/", staffAuth, async (req, res) => {
...
router.get("/paid_per_athlete", staffAuth, async (req, res) => {
  const rows = await Payment.findAllPayedPerAthlete();
  return res.send(rows);
});
